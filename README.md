...
<p>
  ...
  aquí vas a encontrar una serie de funciones escritas de forma fácil y clara, la
  cual puedes usar como clase para aprender sobre funciones en Python 😁. 
</p>
...
1. Clona el repositorio:
    ...
    ```
    git clone https://github.com/Bredalis/Functions.git
    ```
## Uso ⚙️
